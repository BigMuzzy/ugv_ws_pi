...
class BaseController:
    def __init__(self, uart_dev_set, baud_set):
        ...
        # Clear any stale data from previous sessions (important after hard reset)
        time.sleep(0.1)  # Brief delay to allow any residual data to arrive
        self.ser.reset_input_buffer()  # Clear hardware serial buffer
        self.rl.buf.clear()  # Clear ReadLine software buffer
